    ...
    return (
      <div className="w-full max-w-sm text-center">
        ...
        <p className="mb-6 text-sm text-slate-400">
          ...
          <span className="font-medium text-slate-200">{email}</span>. Click the link to activate
          your account.
        </p>
        <Link
          href="/auth/login"
  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-slate-400">Free forever. No credit card required.</p>
      </div>
      ...
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-6">
        ...
        <div className="relative mb-5">
          ...
          <div className="relative flex justify-center">
            <span className="bg-slate-950/50 px-3 text-xs text-slate-500">or sign up with email</span>
          </div>
        </div>
